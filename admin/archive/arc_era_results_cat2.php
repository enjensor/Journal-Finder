...
<?php
		...
		foreach($fields AS $f) {
			...
			if(($f != "ID") && ($f != "Institution")) {
				$queryD = "SELECT COUNT(`$f`) AS World_Standard FROM `2012_era` WHERE `$f` = \"2\"";
				...
				if(($node == 0)) { $em = "#999999"; }
				if(($node > 0) && ($node < 2)) { $em = "#96891a"; }
				if(($node > 1) && ($node < 3)) { $em = "#859019"; }
				if(($node > 2) && ($node < 4)) { $em = "#408417"; }
				if(($node > 3) && ($node < 5)) { $em = "#167d4e"; }
				if(($node > 4) && ($node < 6)) { $em = "#16537d"; }
				if(($node > 5) && ($node < 7)) { $em = "#96321a"; }
				if(($node > 6) && ($node < 8)) { $em = "#89182c"; }
				if(($node > 7) && ($node < 9)) { $em = "#7d1675"; }
				if(($node > 8)) { $em = "#351267"; }
...
d3.json("arc_era_imports.json-cat2.php", function(classes) {
