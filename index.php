...
?>                           
                                    	<div class="col-lg-12" style="padding-left:30px;padding-right:30px;">
                                        	<div class="col-lg-12" style="padding: 30px; background-color:#ffffff;">
                                                ...
                                                <p style="text-align:justify; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 12px;">It is highly recommended that you use Journal Finder to identify and compare a list of relevant journals to target BEFORE you write the article.  Ensuring your work fits the scope, aims and criteria of the journal before you have submitted it for consideration enhances the likelihood of acceptance.  </p>
                                                <p style="text-align:justify; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 12px;">
                                                  <ul style="text-align:justify; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 12px;"><li>This tool is best accessed on the latest version of <a href="https://www.google.com/chrome" target="_GoogleChrome">Google Chrome</a>.</li><li>Do not use the ‘back’ button on your browser. Instead, click on the Journal Finder header in the red band at the top. However, when browsing by research cluster there is a back button built in to that menu.</li></ul></p>
                                                <p style="text-align:justify; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 12px;">If you would like to know more about the rationale behind this project, please click <a href="javascript: var target = document.getElementById('matrixBody'); var spinner = new Spinner().spin(target); var doThis = $( '#matrixBody' ).load( 'arc_paper.php' ); var doThisAlso = $('#scrollingP').scrollTop(0);">here</a> to read a <em>position paper</em>.</p>
                                          </div>
                                          <br />&nbsp;<br />&nbsp;<br />
